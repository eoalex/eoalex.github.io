...
![2016-10-25_16-47-37](/uploads/2016/10/2016-10-25_16-47-37.jpg)
...
![2016-10-26_16-41-55](/uploads/2016/10/2016-10-26_16-41-55.jpg)
...
![2016-11-01_9-05-36](/uploads/2016/11/2016-11-01_9-05-36.jpg)

接下来我们就可以指定输出文件了，为简单起见，示列文件我们输出到文本文件，根据项目需要，可以输出至数据库。如图，Data flow任务，这里我们分别输出head和detail到不同的文件。
![2016-10-30_15-23-48](/uploads/2016/10/2016-10-30_15-23-48.jpg)

整个package运行如下。

![2016-10-30_15-26-22](/uploads/2016/10/2016-10-30_15-26-22.jpg)

对于需要处理大量Infopath XML 数据，只要把以上组件放在一个Foreach Loop Container里就可以了。附示列package包[下载](/uploads/2016/10/InfoPathXML_Sample.7z)