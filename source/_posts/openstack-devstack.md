...
以下是安装devstack过程。
### 2.1 更新源
在软件包管理中心“软件源”中选择“中国的服务器”下`mirros.aliyun.com`即可自动使用
或者直接编辑文件
...
#### 2.11.2 编辑配置文件，修改内存参数
    vi eclipse.ini
   	    XX maxPermSize=1024m
	    -Xms40m
	    -Xmx1024m
    
#### 2.11.3 启动xhost，使所有用户都能访问Xserver.
    Xhost +
#### 2.11.4 启动eclipse
